...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Modulo Evaluación-Agregar  Pregunta cerrada</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                     <h1 class="h3 mb-2 text-gray-800">Agregar  Pregunta cerrada</h1> 
                     <hr>
						
						<a href="index.jsp">Inicio</a> /
						<a href="ListaPreguntaCerrada.jsp">Lista de Preguntas Cerradas</a> /
						<a href="AgregarPregunta_cerrada.jsp">Agregar Pregunta Cerrada </a> 
