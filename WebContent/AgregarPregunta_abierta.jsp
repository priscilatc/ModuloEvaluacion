...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Modulo Evaluación-Agregar  Pregunta abierta</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                     <h1 class="h3 mb-2 text-gray-800">Agregar  Pregunta abierta</h1>   
                    <hr>
						
						<a href="index.jsp">Inicio</a> /
						<a href="ListaPreguntaAbierta.jsp">Lista de Preguntas Abiertas</a> /
						<a href="AgregarPregunta_abierta.jsp"> Agregar Pregunta Periodo</a>
