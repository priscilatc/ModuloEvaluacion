        ...
        <div class="col-md-4">
          <div class="card" style="width: 23rem;">
            ...
            <h5 class="card-header">Preguntas</h5>
               <div class="card-body">
             <a href="ListaDetallePreguntaCerrada.jsp" class="btn btn-primary">
                         <i class="fas fa-table fa-sm text-white-50"></i>
                             <span class="icon text-white-50">
                             </span>
                             <span class="text">Tabla Detalle Pregunta Cerrada</span>
                         </a>
                         
                         <div class="my-2"></div>
                         <a href="ListaDetalleRespuestaCerrada.jsp" class="btn btn-primary">
                         <i class="fas fa-table fa-sm text-white-50"></i>
                             <span class="icon text-white-50">
                             </span>
                             <span class="text">Tabla Detalle Respuesta Cerrada</span>
                         </a> 
                         
                         <div class="my-2"></div>
                         <a href="ListaPreguntaAbierta.jsp" class="btn btn-primary">
                         <i class="fas fa-table fa-sm text-white-50"></i>
                             <span class="icon text-white-50">
                             </span>
                             <span class="text">Tabla Pregunta Abierta</span>
                         </a>  
                         
                         <div class="my-2"></div>
                         <a href="ListaPreguntaCerrada.jsp" class="btn btn-primary">
                         <i class="fas fa-table fa-sm text-white-50"></i>
                             <span class="icon text-white-50">
                             </span>
                             <span class="text">Tabla Pregunta Cerrada</span>
                         </a>  
                         
                         <div class="my-2"></div>
                         <a href="ListaRespuestaPreguntaCerrada.jsp" class="btn btn-primary">
                         <i class="fas fa-table fa-sm text-white-50"></i>
                             <span class="icon text-white-50">
                             </span>
                             <span class="text">Tabla Respuesta Pregunta Cerrada</span>
                         </a>  
                         
                         <div class="my-2"></div>
                         <a href="ListaRespuestaPreguntaAbierta.jsp" class="btn btn-primary">
                         <i class="fas fa-table fa-sm text-white-50"></i>
                             <span class="icon text-white-50">
                             </span>
                             <span class="text">Tabla Respuesta Pregunta Abierta</span>
                         </a> 
                         <div class="my-2"></div> 
