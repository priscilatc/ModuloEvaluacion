		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label text-gpromedix">Nombre: </label>
						<div class="col-sm-6">
							<input id="nombre" name="nombre" type="text" class="form-control has-gpromedix" 
								placeholder="Ej:Administrador" data-toggle="tooltip" minlength="4" maxlength="20"
