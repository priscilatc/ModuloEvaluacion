...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Modulo Evaluación-Editar  Pregunta cerrada</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                     <h1 class="h3 mb-2 text-gray-800">Editar  Pregunta cerrada</h1>
                    <hr>
						
						<a href="index.jsp">Inicio</a> /
						<a href="ListaPreguntaCerrada.jsp">Lista de Preguntas Cerradas</a> /
						<a href="EditarPregunta_cerrada.jsp">Editar Pregunta Cerrada</a>
					...
					%>
					<form class="form-group" method="post" action="./SLgestionPreguntaC">
						...
						<input hidden="true" name="idpreguntacerrada" value="<%=idpreguntacerrada%>">
							...
							<div class="col-sm-6">
								<input id="descripcion" name="descripcion" type="text" class="form-control has-rpromedix" 
									placeholder="Ej:¿Como fue la experiencia de su PPP?" data-toggle="tooltip" minlength="10" maxlength="50"
							data-placement="bottom" title="Min:4 Max:20" value="<%=pc.getDescripcion() %>" required>
							</div>
						...
						<label class="col-sm-2 control-label text-rpromedix">Periodo PPP:</label>
						    <div class="col-sm-6">
						      <select id="idperiodoppp" name="idperiodoppp" class="form-control" required>								        
								...
								if (p.getIdperiodoppp()==pc.getIdPeriodoPPP()){
								%>
