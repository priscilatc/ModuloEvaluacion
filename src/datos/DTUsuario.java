...
//		try{
//			c = PoolConexion.getConnection();
//			ps = c.prepareStatement("Select * from public.vista_usuarioinfo where usuario ='"+ nombre +"'", ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE, ResultSet.HOLD_CURSORS_OVER_COMMIT);
//			rs = ps.executeQuery();
//			
//			while(rs.next()){
//				VW_usuarioinfo infousuario = new VW_usuarioinfo();
//				 
//				infousuario.setUsuario("usuario");
//				infousuario.setRol("rol"); 
//				
//				listainfoUsuario.add(infousuario);
//			}
//		}
//		catch (Exception e){
...
//			catch (Exception e2) 
//			{
//				System.err.println("DT USUARIO: Error en cerrar usuarios " + e2.getMessage());
//				e2.printStackTrace();
//			}
//		}
//		return listainfoUsuario;
//	}
